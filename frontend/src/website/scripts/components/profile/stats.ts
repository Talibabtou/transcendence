...
import { renderEloChart } from './charts/eloChart';
import { renderMatchDurationChart } from './charts/matchDurationChart';
import { renderDailyActivityChart } from './charts/dailyActivityChart';
import { renderGoalDurationChart } from './charts/goalDurationChart';
  ...
  render(): void {
    ...
    const template = html`
      <div class="stats-content">
        <h1>Player Performance Statistics</h1>
    ...
    // After rendering, initialize charts if data is loaded
