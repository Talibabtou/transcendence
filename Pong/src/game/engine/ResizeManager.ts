...
export class ResizeManager {
  ...
  private readonly ball: Ball | null;
  private readonly player1: Player | null;
  private readonly player2: Player | null;
  private readonly pauseManager: PauseManager | null;
